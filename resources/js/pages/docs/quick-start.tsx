...
import DocsSupportedItems, { Badge } from '@/components/docs-supported-items';
    ...
    return (
        <DocsLayout title="Quick Start" currentPath="/docs/quick-start">
            ...
            <p className="text-lg text-slate-400">
                Get up and running with the VTU API in just 5 minutes. This guide walks you through 
                the essential steps to make your first API request.
            </p>
            ...
            <p>
                All requests to the VTU API must include your API key in the <code>Authorization</code> header 
...
export BASE_URL="https://api.your-domain.com/api/v1"`}
            ...
            <p>
                Select which environment to use for your requests. Start with Sandbox for testing.
            </p>
            ...
            <p>
                Let's start with a simple operation: buying airtime. Here's how to do it with different tools.
            </p>
                    ...
                    content: (
                        <>
                            ...
                            <ol className="list-decimal list-inside space-y-2 text-slate-300">
                                ...
                                <li>Set URL: <code className="bg-slate-800/50 px-2 py-1 rounded">https://api.your-domain.com/api/v1/airtime</code></li>
                                <li>Go to Headers tab</li>
                                <li>Add: <code className="bg-slate-800/50 px-2 py-1 rounded">Authorization: Bearer YOUR_API_KEY</code></li>
...
if result['status']:
    ...
    print(f"Error: {result['message']}")`}
            ...
            <p>
                The API returns a JSON response with a consistent structure. All successful requests 
                will have <code>status: true</code>.
            </p>
            ...
            <Callout type="warning" title="Common Errors">
                <ul className="space-y-1 text-sm">
                    <li>✗ <strong>INSUFFICIENT_BALANCE</strong> - Wallet balance is too low</li>
                    <li>✗ <strong>INVALID_NETWORK</strong> - Network parameter is invalid</li>
                    <li>✗ <strong>INVALID_PHONE</strong> - Phone number format is incorrect</li>
                    <li>✗ <strong>SERVICE_UNAVAILABLE</strong> - Network provider temporarily unavailable</li>
                </ul>
            </Callout>
  ...
  "data": {
    ...
    "current_balance": 250
            ...
            <Callout type="success" title="You're ready!">
                Congratulations! You now have everything you need to start integrating the VTU API. 
                Check out the endpoint documentation for more operations.
            </Callout>
